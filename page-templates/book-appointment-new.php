...
<div id="primary" class="content-area">
	...
	<section class="site-main row directions">
		<div class="large-6 columns bg-green">
			...
			<p>We’ve made the entire check-in process a no-contact experience. Simply complete the online pre-visit process prior to your visit and utilize our two-way texting service once you arrive. That way, you can go directly from the safety of your car, straight into a disinfected exam room. You’ll bypass the paper forms, other patients, and any touching of pens, paper, or clipboards.</p>
		</div>
